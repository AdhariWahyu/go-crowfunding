...
func main() {
	dsn := "root:@tcp(127.0.0.1:3306)/go-be-cfd?charset=utf8mb4&parseTime=True&loc=Local"
	...
	router.Use(sessions.Sessions("go-be", cookieStore))
